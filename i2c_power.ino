...
void sendData(){
  if(number == 0x00){
    ...
    uint8_t lower_high = locked_time;
    uint8_t middle_low = locked_time;
    uint8_t middle_high = locked_time;
    uint8_t upper_low = locked_time;
    uint8_t upper_high = locked_time >> 24;
    uint8_t barr[] = {lower_low,lower_high,middle_low,middle_high,upper_low,upper_high};
    Wire.write(barr, 2);
  }
  else
    Wire.write(69);
